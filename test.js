...
function addPlaceToSidebar(place) {
    ...
    li.innerHTML = '<a href="#" onclick="openInSidebar(\'' + place.place_url + '\', \'' + place.place_name + '\')">' + place.place_name + '</a>'; // URL 링크 추가
    sidebar.appendChild(li);
}

function openInSidebar(url, name) {
    var newSidebarContent = document.getElementById('sidebar-content');
    newSidebarContent.innerHTML = '<iframe src="' + url + '" title="' + name + '" style="width:100%;border:none;" onload="resizeIframe(this)"></iframe>';
}
...
function fetchWeather(lat, lon) {
    var apiKey = 'adb67de4a557753e101c9a33b531a4d6'; // OpenWeatherMap API 키를 여기에 입력하세요
    ...
    fetch(url)
        ...
        .then(data => {
          ...
          document.getElementById("weatherInfo").innerText = `현재 위치: ${data.name}, 현재 날씨: ${weatherDescription}, 온도: ${temperature}°C`;
        })
